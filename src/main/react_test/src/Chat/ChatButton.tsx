...
export default function ChatButton(){
    ...
    return(
        <button className={"btn btn-outline-secondary ChatButton"} onClick={() => window.open("/ChatList", "ChatList","status=no, height=500, width=380" )}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-wechat"
                 viewBox="0 0 16 16">
                <path
